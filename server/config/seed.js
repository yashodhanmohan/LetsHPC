...
Category.find({}).remove()
    .then(() => {
        Category.create({
                category_id: 1,
                category_name: 'Reduction',
                category_desc: 'This is the classic reduction stratergy'
            },
	    {
                category_id: 2,
                category_name: 'Matrix Related',
                category_desc: 'Matrix Related Operations'
            })
            .then(() => {
...
Problem.find({}).remove()
    .then(() => {
        Problem.create({
                problem_id: 1,
                problem_name: 'Finding the sum',
                problem_desc: 'This is a test problem'
            },
		{
                problem_id: 2,
                problem_name: 'Matrix Multiplication',
                problem_desc: 'This is a test matrix multiplication'
            })
            .then(() => {
...
Apmap.find({}).remove()
    .then(() => {
        Apmap.create({
                apmap_problem_id: 1,
                apmap_approach_id: 1,
                apmap_approach_desc: 'Tree based approach'
            },
	    {
                apmap_problem_id: 2,
                apmap_approach_id: 2,
                apmap_approach_desc: 'Parallelizing the Outermost loop'
            })
            .then(() => {
